...
does not retain immutable corpus generations or provide rollback. The tracked
8,286-chunk artifact differs from the 9,675 rows regenerated by profile v2, so
the tracked corpus currently fails strict publication.
