...
call('initialize', {'protocolVersion':'2024-11-05','capabilities':{},'clientInfo':{'name':'smoke','version':'0.0.1'}}, rid=1)
...
for p in pages:
    out = call('tools/call', {'name':'get_bddk_document','arguments':{'document_id':doc_id,'page_number':p}}, rid=100+p)
