...
def test_verify_corpus_checks_tracked_artifacts_and_reports_safe_identity(capsys):
    ...
    output = capsys.readouterr().out
    assert "id=bddk-job-corpus-quality-repairs-local-v6-2026-09-21" in output
...
def test_verify_corpus_production_requirements_reflect_owner_policies(capsys):
    ...
    assert "id=bddk-job-corpus-quality-repairs-local-v6-2026-09-21" in capsys.readouterr().out
