...
def test_benchmark_manifest_identity_is_verified_and_path_free():
    ...
    assert identity["manifest_id"] == "bddk-job-corpus-quality-repairs-local-v6-2026-09-21"
...
async def test_phase2_result_retains_auditable_trace_and_separates_retrieval_comparability(monkeypatch):
    ...
    assert (
        result["run_metadata"]["corpus_manifest"]["manifest_id"]
        == "bddk-job-corpus-quality-repairs-local-v6-2026-09-21"
    )
