...
- 14 kategoriye göre filtreleme, tarih aralığı filtreleme
...
- 3 katmanlı doküman çıkarma (Nougat GPU, markitdown, HTML)
...
- GitHub Actions CI (lint + test), 238 test
...
- Category filtering (14 categories), date range filtering
...
- 3-layer document extraction (Nougat GPU, markitdown, HTML)
...
- GitHub Actions CI (lint + test), 238 tests
...
|---|---|---|
| Kurul Kararı | Kurul Kararları (yayımlanmış ve yayımlanmamış) | ~957 |
...
| Finansal Kiralama ve Faktoring | Kiralama ve Faktoring Düzenlemeleri | 7 |
...
| Faizsiz Bankacılık | İslami Bankacılık Düzenlemeleri | 2 |
...
| 52 | bddk.org.tr/Mevzuat/Liste/52 | Kiralama, Faktoring, Finansman düzenlemeleri |
| 54 | bddk.org.tr/Mevzuat/Liste/54 | BDDK iç düzenlemeleri |
| 55 | bddk.org.tr/Mevzuat/Liste/55 | Kurul Kararları (yayımlanmış) |
| 56 | bddk.org.tr/Mevzuat/Liste/56 | Kurul Kararları (yayımlanmamış) |
