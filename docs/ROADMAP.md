...
| R-08 | Manifest/import contract and v5 publication persistence complete; governed release open | Bootstrap emits the identity and requires a distinct publisher; the publisher persists the release and activation together. The tracked corpus is unsigned, unquantified, unmeasured, and its declared chunks drift from current regeneration. Immutable retained generations remain open. |
